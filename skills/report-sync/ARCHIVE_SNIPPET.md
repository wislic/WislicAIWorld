# WislicWorld 自动归档提示词片段

> 将以下内容复制粘贴到任何 Cowork project 的 SKILL.md 末尾，即可让该 project 生成的 HTML 报告自动归档到 WislicWorld。
> 
> 使用前提：该 Cowork session 需要挂载包含 WislicWorld 文件夹的目录（即 `/Users/wislic/Documents/Claude` 或直接挂载 WislicWorld）。
...
**Step 4** — 验证：确认文件已复制且大小 > 0，确认 reports.json 格式正确
...
### 宏观日报（macro-daily-report）
- category: `daily`
- filename: `2026-04-08.html`
- title: `宏观经济与大类资产日报 2026-04-08`

### 盘中速览（midday-market-snapshot）
- category: `flash`
- filename: `fixed-income-flash-2026-04-08.html`
- title: `固收+盘中速览 2026-04-08`

### 市场温度计（market-thermometer-update）
- category: `flash`
- filename: `market-thermometer-2026-04-08.html`
- title: `市场温度计 2026-04-08`

### 周报（weekly-macro-report / weekly-report-generation）
- category: `other`
- filename: `weekly-macro-W15-2026.html`
- title: `宏观经济与大类资产周报 W15 (2026.04.07-04.11)`

### 九周期定位（nine-cycle-position-update）
- category: `other`
- filename: `nine-cycle-update-2026-04-08.html`
- title: `九大经济周期定位更新 2026-04-08`

### 专题研究（任意 project 生成的深度分析）
- category: `deep`
- filename: `topic-name.html`（如 `oil-supply-analysis.html`）
- title: 报告中文标题
